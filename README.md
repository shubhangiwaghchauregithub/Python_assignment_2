...
Input: The program prompts the user to enter an integer using input().
...
Task 2
he program calculates the total sum of all integers starting from 1 up to 50.

How the Program Works
Initialization: A variable sum is initialized to 0 to store the cumulative total.
